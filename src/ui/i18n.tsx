...
const dictionary: Record<string, string> = {
  ...
  "Open Services Folder": "Открыть папку сервисов",
  "More tools": "Дополнительные инструменты",
  "Open Projects Folder": "Открыть папку проектов",
  "Edit Databases": "Редактировать базы",
  "Manage Host Database": "Настроить базу хоста",
  "Edit in phpMyAdmin": "Редактировать в phpMyAdmin",
  ...
  "Automatically install LocalStack Pro updates": "Автоматически устанавливать обновления LocalStack Pro",
  "CMS Updates": "Обновления CMS",
  "Check CMS Updates": "Проверить обновления CMS",
  "Update All CMS": "Обновить все CMS",
  "Automatically update installed CMS": "Автоматически обновлять установленные CMS",
  "Current Version": "Текущая версия",
  "Latest Version": "Последняя версия",
  Update: "Обновить",
  "Check CMS Updates to inspect installed CMS.": "Нажмите «Проверить обновления CMS», чтобы проверить установленные CMS.",
  ...
  "Project host": "Хост проекта",
  "Check Project Tools": "Проверить инструменты проекта",
  "Typed database schema and migration toolkit": "Инструменты типизированной схемы БД и миграций",
  "Extensible rich-text editor toolkit": "Расширяемый набор инструментов текстового редактора",
  "A Node.js project with package.json is required": "Нужен Node.js-проект с package.json",
  ...
  "Host for SSL certificate": "Хост для SSL-сертификата",
  ...
  "Your LocalStack CA is trusted by this system.": "Локальный CA LocalStack доверен этой системой.",
  "Web browsers on this machine will trust certificates issued by LocalStack CA for the domains listed above.": "Браузеры на этом компьютере будут доверять сертификатам LocalStack CA для доменов выше.",
  "Issued To": "Выдано для",
  "Issued By": "Выдано",
  "Fingerprint (SHA-256)": "Отпечаток (SHA-256)",
  "Valid Until": "Действителен до",
  "If the site shows a certificate warning, click Repair Trust.": "Если сайт показывает предупреждение сертификата, нажмите исправление доверия.",
  Missing: "Отсутствует",
  Revoke: "Отозвать",
